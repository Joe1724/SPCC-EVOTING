...
<body class="flex flex-col min-h-screen">
    ...
    <nav class="flex items-center justify-between w-full p-4 bg-white shadow">
        ...
        <!-- Links -->
        <div class="space-x-4">
            <a href="{{ route('login') }}" class="px-4 py-2 text-white transition bg-blue-500 rounded-lg hover:bg-blue-600">
                Login
            </a>
            <a href="{{ route('register') }}" class="px-4 py-2 text-blue-500 transition bg-white border border-blue-500 rounded-lg hover:bg-blue-50">
                Register
            </a>
            <a href="{{ route('livecount') }}" class="px-4 py-2 text-green-600 transition bg-white border border-green-600 rounded-lg hover:bg-green-50">
                Live Counting
            </a>
        </div>
    </nav>
    ...
    <main class="flex flex-col items-center justify-center flex-grow px-4 text-center">
        ...
        <a href="{{ route('login') }}" class="px-6 py-3 text-lg text-white transition bg-blue-500 rounded-lg hover:bg-blue-600">
            Get Started
        </a>
    </main>
